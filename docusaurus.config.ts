...
const config: Config = {
  ...
  organizationName: 'nerdynot', // Usually your GitHub org/user name.
  projectName: 'nerdynot.github.io', // Usually your repo name.
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} NerydNot.`,
    },
    prism: {
